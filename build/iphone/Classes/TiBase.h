...
// in simulator we redefine to format for HNReader Developer console
...
{\
	NSString * exceptionName = [@"org.hnreader." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hnreader";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIHNReaderNativeItemNone = -1, 
	UIHNReaderNativeItemSpinner = -2,
	UIHNReaderNativeItemProgressBar = -3,
	
	UIHNReaderNativeItemSlider = -4,
	UIHNReaderNativeItemSwitch = -5,
	UIHNReaderNativeItemMultiButton = -6,
	UIHNReaderNativeItemSegmented = -7,
	
	UIHNReaderNativeItemTextView = -8,
	UIHNReaderNativeItemTextField = -9,
	UIHNReaderNativeItemSearchBar = -10,
	
	UIHNReaderNativeItemPicker = -11,
	UIHNReaderNativeItemDatePicker = -12,
	
	UIHNReaderNativeItemInfoLight = -13,
	UIHNReaderNativeItemInfoDark = -14,
	
	UIHNReaderNativeItemDisclosure = -15,
	
	UIHNReaderNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all HNReader instances of
