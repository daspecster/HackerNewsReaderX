 ...
 * Copyright (c) 2009-2011 by HNReader, Inc. All Rights Reserved.
...
//@interface HNReaderObject : NSObject
//@end

@interface HNReaderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HNReaderObject class]])
		{
			for (NSString *key in [[(HNReaderObject*)o modules] allKeys])
			{
